  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed inset-0 z-50 bg-[#1a1a1a]/40 backdrop-blur-xs transition-opacity duration-300 ease-in-out ${
      ...
      <div
        className={`fixed inset-y-0 right-0 z-50 flex w-full max-w-md flex-col bg-[#fcfcfc] shadow-2xl border-l border-[#e5e5e5] transition-transform duration-300 ease-in-out ${
